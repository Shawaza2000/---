...
let fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '𝑌𝐴𝑺𝛩𝛩-𝐵𝛩𝑇', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '𝑌𝐴𝑺𝛩𝛩-𝐵𝛩𝑇', 'jpegThumbnail': false}}};
...
await conn.sendContact(m.chat, [[`201508901086` + `@s.whatsapp.net`, wm]], vn, {
 contextInfo: { 
